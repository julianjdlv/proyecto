...
public class BuscarInventario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Nombre Peliculas");
        ...
        consolatxt.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Terror", "Accion", "Suspenso", "Comedia" }));
    ...
    private void bActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bActualizarActionPerformed
        ...
        ActualizarPelicula act =new ActualizarPelicula(Integer.valueOf(idtxt.getText()));
         ControladorPelicula c=new ControladorPelicula(act);
        act.setVisible(true);
        this.dispose();
    }
